...
::
::YAwzoRdxOk+EWAjk
::fBw5plQjdCyDJGyX8VAjFDpQQQ2MNXiuFLQI5/rH3+OEtlgPUfEDWYHS17GyCeMcqmPteZM+6iNl1sIPA3s=
::YAwzuBVtJxjWCl3EqQJhSA==
::ZR4luwNxJguZRRmi7Vc9IXs=
::Yhs/ulQjdF+5
::cxAkpRVqdFKZSDk=
::cBs/ulQjdF+5
::ZR41oxFsdFKZSDk=
...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFDpQQQ2MNXiuFLQI5/rHy++UqVkSRN4IcYHf1aOdYNQE70TvcIRt9GMavtIZARIWewquDg==
::YB416Ek+ZW8=
::
::
...
echo.[97m
set /p fyumi=:
if /i %fyumi%==skip goto ngonngu
if /i %fyumi%==restore goto restorepoint
cls
echo.
echo.
...
echo.
set /p fyumi=:
if /i %fyumi%==eng goto loadingmenutienganh
if /i %fyumi%==vie goto comingsoon
cls
echo.
echo.
echo.      [97mYou entered the wrong choice, please enter again!
...
echo.[38;5;69mWelcome %USERNAME%, to Fyu Tool!
echo.
echo.
echo.                     [38;5;33m           █     █░ ██▓ ███▄    █ ▓█████▄  ▒█████   █     █░  ██████    ▄▄▄█████▓ █     █░▓█████ ▄▄▄       ██ ▄█▀▓█████  ██▀███  
echo.                     [38;5;69m          ▓█░ █ ░█░▓██▒ ██ ▀█   █ ▒██▀ ██▌▒██▒  ██▒▓█░ █ ░█░▒██    ▒    ▓  ██▒ ▓▒▓█░ █ ░█░▓█   ▀▒████▄     ██▄█▒ ▓█   ▀ ▓██ ▒ ██▒
...
echo.                            
set /p fyumi=:
if /i %fyumi% == 1 goto cleanupalltrash
if /i %fyumi% == 2 goto debloatwindows
if /i %fyumi% == 3 goto disableunecessaryservices
if /i %fyumi% == 4 goto selectapptodelete
if /i %fyumi% == 5 goto capturetheregistry
if /i %fyumi% == 6 goto menutienganh
if /i %fyumi% == 1F goto sorry
if /i %fyumi% == 2F goto sorry
if /i %fyumi% == 3F goto sorry
if /i %fyumi% == 4F goto sorry
...
del /s /f /q %userprofile%\AppData\Roaming\Microsoft\Windows\Recent\* >nul
...
rd /s /q %systemroot%\System32\FNTCACHE.DAT >nul
rd /s /q %userprofile%\AppData\Local\Microsoft\Windows\Explorer >nul
...
echo.
set /p fyumi=:
if /i %fyumi% == 1 goto debloatwindows10
if /i %fyumi% == 2 goto debloatwindows11
if /i %fyumi% == 3 goto debloats
if /i %fyumi% == 1F goto sorry
if /i %fyumi% == 2F goto sorry
cls
echo.
...
:selectapptodelete
curl -L -o %TEMP%\Windows10AppsManager.exe https://github.com/FyumiSownz/Windows-Tweaker-Resources/raw/91d96e8085cc68faae1c9b298cf30cb0c45c0cbb/Windows%2010%20Apps%20Manager.exe && powershell -Command "Start-Process -FilePath '%TEMP%\Windows10AppsManager.exe' -Verb RunAs"
cls
goto debloats

:capturetheregistry
curl -o %TEMP%\Windows_Debloater.ps1 https://raw.githubusercontent.com/FyumiSownz/Windows-Tweaker-Resources/refs/heads/main/Windows%20Debloater.ps1 && timeout /t 2 >nul && powershell -Command "Start-Process powershell -ArgumentList '-ExecutionPolicy Bypass -File \"%TEMP%\Windows_Debloater.ps1\"' -Verb RunAs"
cls
goto debloats
...
echo.                            
set /p fyumi=:
if /i %fyumi% == 1 goto optimizeintelcpu
if /i %fyumi% == 2 goto optimizeamdcpu
if /i %fyumi% == 3 goto boostperformance 
if /i %fyumi% == 4 goto menutienganh
if /i %fyumi% == 1F goto sorry
if /i %fyumi% == 2F goto sorry
if /i %fyumi% == 3F goto sorry
cls
...
echo.                            
set /p fyumi=:
if /i %fyumi% == 1 goto optimizeintelgpu
if /i %fyumi% == 2 goto optimizeamdgpu
if /i %fyumi% == 3 goto optimizenvidiagpu
if /i %fyumi% == 4 goto menutienganh
if /i %fyumi% == 1F goto sorry
if /i %fyumi% == 2F goto sorry
if /i %fyumi% == 3F goto sorry
...
echo.                            
set /p fyumi=:
if /i %fyumi% == 1 goto reduceping
if /i %fyumi% == 2 goto boostinternet
if /i %fyumi% == 3 goto networktweaks
if /i %fyumi% == 4 goto menutienganh
if /i %fyumi% == 1F goto sorry
if /i %fyumi% == 2F goto sorry
if /i %fyumi% == 3F goto sorry
...
echo.                            
set /p fyumi=:
if /i %fyumi% == 1 goto 4gbram
if /i %fyumi% == 2 goto 8gbram
if /i %fyumi% == 3 goto 16gbram
if /i %fyumi% == 4 goto 32gbram
if /i %fyumi% == 5 goto revertram
if /i %fyumi% == 6 goto menutienganh
if /i %fyumi% == 1F goto sorry
if /i %fyumi% == 2F goto sorry
if /i %fyumi% == 3F goto sorry
...
echo.                            
set /p fyumi=:
if /i %fyumi% == 1 goto ssd
if /i %fyumi% == 2 goto hhd
if /i %fyumi% == 3 goto menutienganh
if /i %fyumi% == 1F goto sorry
if /i %fyumi% == 2F goto sorry
cls
echo.
...
echo.                            
set /p fyumi=:
if /i %fyumi% == 1 start https://www.facebook.com/quang.son.73550794 & goto about
if /i %fyumi% == 2 start https://www.facebook.com/profile.php?id=61570289644520&is_tour_completed & goto about
if /i %fyumi% == 3 start https://www.youtube.com/@winx1948 & goto about
if /i %fyumi% == 4 start https://discord.gg/rV4DjZnP & goto about
if /i %fyumi% == 5 goto menutienganh
cls
echo.
echo.
echo.      [97mYou entered the wrong choice, please enter again!
